---
description: Start the Solution Intent stage — point a fresh Copilot agent at this run's UI_INPUT and act as solution_intent_author.
---
...
transition; do **not** perform it (FR-XS-11): tell the operator to open a new thread (`Ctrl+N`),
