...
Each brand imposes operational rules on the message contract — mandatory fields, allowed values, and
certification constraints — that the format layer enforces before dispatch.
