---
description: Start the enrichment stage — point a fresh agent at the frozen v1 and run both arms, the walkthrough, then the apply pass.
---
...
perform it (FR-XS-11): tell the operator to `/clear` or start a new session, then run
