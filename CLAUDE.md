...
3. **`docs/OPEN_RULINGS.md`** — the decisions awaiting V. Eight open items, each with options and a recommendation. **Check it before acting on anything it covers**; a struck-through item carries the ruling and its date.
